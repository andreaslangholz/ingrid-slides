...
Every sales conversation has a shape. This is ours:
...
| Beat | ~Share | Purpose |
|------|--------|---------|
| The Hook | 5% | Start in their world |
| The Pain | 15% | Deepen the problem |
| Cost of Inaction | 10% | Make doing nothing expensive |
| The Solution | 15% | What you built |
| Proof | 20% | Customers like them |
| How It Works | 10% | Remove friction |
| Pricing / Packaging | 10% | Anchor value |
| The Ask | 5% | One clear next step |
| Close | 5% | The line they'll repeat |
...
> **"Your team ships 3 features a quarter.** <span class="dim">Your competitor ships 12."</span>
> **"63% of deals stall** <span class="dim">after the second call."</span>
> **"You're spending $400K/year** <span class="dim">on a process that doesn't scale."</span>
> **"Your best rep just quit.** <span class="dim">Again."</span>

**Purpose:** Earn the next 60 seconds. Create a gap between where they are and where they want to be.

**What belongs:** One stat, one provocative observation, one question they've asked themselves in the shower. Something specific to their industry or role.

**What doesn't:** Your logo. Your tagline. "About us." Anything that makes them feel like they're being pitched.
...
> **"Every quarter you wait** <span class="dim">costs $180K in lost pipeline."</span>
...
- Being dishonest about urgency. Prospects can smell artificial scarcity.
- Making it too long. One slide. One punch. Move on.
...
- Leading with how it works instead of what it does for them.
- Using your internal language instead of their language.
...
The best proof is a customer who looks like them, had the same problem, and solved it with you. If you can get that specific, you win.
...
**What belongs:** Named customers (with permission). Specific metrics with timeframes. Before/after comparisons. Quotes from people in the same role as the buyer. Logos they recognize.
...
**What belongs:** A clear process (3–5 steps). Timelines. Who does what. When they see first value. What support looks like.
...
> **"$80K/year.** <span class="dim">You told us the problem costs $400K."</span>
> Two-column: Growth tier vs. Enterprise tier.
> Capability list: what's included in each tier.

**Purpose:** Make the price feel small relative to the value. Remove ambiguity. Let them do the math.
...
- Making it too complex. If the prospect can't explain the pricing to their CFO in one sentence, simplify it.
- Showing pricing before value. The sequence matters. Cost of Inaction → Solution → Proof → Pricing. In that order.
...
> **"Let's run a pilot in Q3.** <span class="dim">Four reps. Four weeks. We'll prove it."</span>
> **"I'll send the contract Tuesday.** <span class="dim">You'll have it by noon."</span>
> **"Next step: a 30-minute deep dive with your team** <span class="dim">next Thursday."</span>

**Purpose:** Convert interest into action. A deal without a next step is a dead deal.

**What belongs:** One clear CTA. A specific timeline. Who does what. What the prospect needs to do (and how little it is).

**What doesn't:** Multiple options. "We could do X or Y or Z." Pick one. If they push back, adapt. But lead with one clear path.

**Components:** Quote slide with the ask as a bold statement. Or eyebrow + headline + subtitle with the details.
...
> **"You're 4 weeks away** <span class="dim">from never having this problem again."</span>
> **"This is what your pipeline looks like** <span class="dim">when nothing slips through."</span>
> **"Your best quarter is ahead of you.** <span class="dim">Let's go get it."</span>
> **"Stop managing the chaos.** <span class="dim">Fix it."</span>

**Purpose:** Give them language. The champion in the room needs a sentence to carry upstairs. This is that sentence.

**What belongs:** One bold line. Maybe a subtitle. Nothing else. White space. Confidence.

**What doesn't:** Logos. Contact information (save that for a follow-up email). Lengthy summaries. "Any questions?"
...
After you finish your deck, ask this question: could your prospect use this deck to sell internally without you in the room?
...
## Personalizing for the prospect
...
## Adapting for deal size

### SMB (< $50K ACV)

- Shorter deck. 10–15 slides max.
- Skip the "Cost of Inaction" beat or compress it to one stat.
- Pricing should be on-screen and unambiguous.
- The ask is immediate: "Start a trial" or "Let's go live next week."
- Speed matters more than depth.

### Mid-market ($50K–$200K ACV)

- Full nine-beat structure.
- Two to three proof stories, at least one in their industry.
- The ask is a defined next step: pilot, technical review, contract.
- You'll present this 2–3 times to different stakeholders. Make it champion-ready.

### Enterprise / Strategic (> $200K ACV)

- The deck is one artifact in a longer sales process.
- Add depth to proof: named customers, detailed case studies, ROI models.
- The "How It Works" section needs more detail: implementation timeline, team requirements, integration points.
- The ask is a process: "Here's what the next 30 days look like."
- Consider a separate executive summary (3–5 slides) for the C-suite meeting.
...
### Follow-up deck (after a discovery call)
...
| Objection | Go to |
|-----------|-------|
| "We're not sure this is a priority" | Cost of Inaction |
...
## The headline pattern (for sales)

The bold-then-dim pattern is especially powerful in sales because it does two things at once: states the claim and softens the extension.
...
- **Solution headlines:** Bold = the capability. Dim = what it means for them.
- **Proof headlines:** Bold = the metric. Dim = the timeframe or context.
- **Ask headlines:** Bold = the action. Dim = how easy it is.
...
If you know their world better than they expect you to, you won't need a perfect deck. You'll need three slides and a good question.
