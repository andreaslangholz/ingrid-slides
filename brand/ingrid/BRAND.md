...
Three elements:
1. **Three solid rounded-corner squares** in an L/grid pattern (top-left, top-right, bottom-right of a 2×2 grid) — black on light bg, white on dark bg
2. **One Flux Violet circle** (`#AA73FA`) at bottom-left — the "thinking brain" / intelligence node
3. Together these form The Arc symbol — structure + intelligence joined

The Arc is used as: full mark (in logo), app/digital icon (white mark on black square), uniform print, social media profile avatar.
